    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            if(isset($_SESSION['loggedIn'])) {
                ...
                echo '<li><a class="btn btn-secondary" href="user.php"> Welcome, '.$_SESSION['loggedIn'].'</a></li>';
    ...
    <div class = "row">
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href = "trade.php" class="list-group-item">Trade Cards</a>
            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>5$</h5>
                            <p class="card-text">5 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>10$</h5>
                            <p class="card-text">10 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                        <form class="card-footer" method ="POST">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>20$</h5>
                            <p class="card-text">20 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                        <form class="card-footer" method ="POST">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>30$</h5>
                            <p class="card-text">30 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                        <form class="card-footer" method ="POST">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>40$</h5>
                            <p class="card-text">40 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                        <form class="card-footer" method ="POST">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <h5>50$</h5>
                            <p class="card-text">50 stickers of 1990 Marvel's Sticker Album</p>
                        </div>
                        <form class="card-footer" method ="POST">
